namespace Wanamics.WanaMisc.Employee;

using Microsoft.HumanResources.Employee;
using Microsoft.Foundation.Period;
using Microsoft.HumanResources.Payables;
report 87068 "wan Employee - Trial Balance"
//report 329 "Employee - Trial Balance"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReportLayouts/EmployeeTrialBalance.rdl';
    ...
    trigger OnPreReport()
    begin
        PeriodFilter := Employee.GetFilter("Date Filter");
        PeriodStartDate := Employee.GetRangeMin("Date Filter");
        PeriodEndDate := Employee.GetRangeMax("Date Filter");
        Employee.SetRange("Date Filter");
        EmplFilter := Employee.GetFilters();
